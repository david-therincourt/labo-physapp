...
| --------- | ------------------ | --------------------------------------------------------- | --- |
| AD711     | AO BiFET précision | Faible offset, faible bruit, usage général (equiv. TL081) |     |
| CA3130    | AO CMOS/BiMOS      | Entrée MOSFET, sortie rail-to-rail                        |     |
| CA3140    | AO BiMOS           | Très haute impédance d'entrée (MOSFET), haute vitesse     |     |
...
### Amplificateurs différentiels et d'instrumentation
...
| TDB039 | Régulateur fixe | Régulateur de tension (équiv. 78xx) | |
...
| SFC2741 | Régulateur ajustable | Régulateur de tension (série SFC) | |
